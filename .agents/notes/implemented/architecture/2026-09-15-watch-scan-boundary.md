...
|---|---|
| [Replication Pull](../../proposed/bug-fix/2026-09-07-replication-pull-cursor-progress.md) | Connect the two phases, public opaque checkpoint, bounded responses, HTTP/gRPC and manual SDK. Store delivery alone does not fix public Pull. Retain C0 through scanning and never advance beyond accepted frames. |
